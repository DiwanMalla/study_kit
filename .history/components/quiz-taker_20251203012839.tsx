...
export function QuizTaker({ questions, studyKitId, studyKitTitle, quizTitle }: QuizTakerProps) {
      ...
      <div className="space-y-8">
        ...
        <Card className="text-center">
          <CardContent className="py-12">
            <Trophy className={`h-16 w-16 mx-auto mb-4 ${percentage >= 70 ? "text-yellow-500" : "text-muted-foreground"}`} />
          ...
          {currentQuestion.options.map((option, idx) => {
            ...
            if (showResult) {
              if (idx === currentQuestion.correctAnswer) {
                className += " bg-green-100 dark:bg-green-900 border-green-500 hover:bg-green-100";
              } else if (idx === selectedAnswer) {
                className += " bg-red-100 dark:bg-red-900 border-red-500 hover:bg-red-100";
              }
            } else if (idx === selectedAnswer) {
