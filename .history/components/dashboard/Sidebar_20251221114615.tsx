...
const mainNav = [
  ...
  { name: "Pricing", href: "/dashboard/pricing", icon: "payments" },
  {
    name: "Toggle theme",
    href: "#",
    icon: "dark_mode",
...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 h-full flex flex-col border-r border-border bg-background shrink-0 transition-colors duration-300 z-20 hidden md:flex">
      <div className="p-6">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "text-muted-foreground hover:bg-slate-200 dark:hover:bg-surface font-medium"
                  )}
                >
      ...
      <div className="p-4 mt-auto">
        <Link
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-full text-muted-foreground hover:bg-slate-200 dark:hover:bg-surface transition-all mb-2"
        >
