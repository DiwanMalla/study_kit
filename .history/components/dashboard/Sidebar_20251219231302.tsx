...
const mainNav = [
  ...
  { name: "Toggle theme", href: "#", icon: "dark_mode", onClick: () => {
...
const toolsNav = [
  ...
  { name: "AI Tutor", href: "/dashboard/ai-tutor", icon: "smart_toy" },
  { name: "Assignment Helper", href: "/dashboard/assignment-helper", icon: "edit_note" },
  { name: "AI Summary", href: "/dashboard/ai-summary", icon: "summarize" },
  { name: "Flashcard AI", href: "/dashboard/flashcards", icon: "style" },
  { name: "Quiz", href: "/dashboard/quiz", icon: "check_circle" },
  { name: "Exam", href: "/dashboard/exam", icon: "school" },
];
        ...
        <div className="flex flex-col">
          <Link href="/dashboard" className="flex items-center gap-2 group">
            <svg className="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M6 13.5V21.5C6 22.8807 10.4772 24 16 24C21.5228 24 26 22.8807 26 21.5V13.5L16 19L6 13.5Z" opacity="0.5"></path>
          ...
          <p className="text-muted-foreground text-xs font-normal leading-normal mt-1 ml-10">Basic Plan</p>
        </div>
      </div>

      <nav className="flex-1 overflow-y-auto px-4 space-y-6">
        <div>
          <p className="px-4 text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">Main</p>
        ...
        <div>
          <p className="px-4 text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">Tools</p>
          <div className="space-y-1">
            {toolsNav.map((item) => (
              <Link
                key={item.name}
