  ...
  if (questions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-6">
        ...
        <Button
          asChild
          className="bg-primary text-slate-900 font-bold px-8 py-6 rounded-xl"
        >
    ...
    return (
      <div className="max-w-4xl mx-auto w-full py-10 px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <Button
            asChild
            className="bg-primary text-slate-900 font-bold px-8 py-6 rounded-xl text-lg shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all"
          >
            <Link href="/dashboard/quiz">Back to Quiz List</Link>
          </Button>
        </div>
        ...
        <div className="space-y-6">
          ...
          {questions.map((q, idx) => {
            ...
            return (
              <Card
                key={q.id}
                className="bg-surface-light dark:bg-surface-dark border-border-light dark:border-border-dark rounded-2xl overflow-hidden shadow-sm"
              >
