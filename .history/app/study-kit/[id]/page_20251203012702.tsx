    ...
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{studyKit.flashcards.length}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold capitalize">{studyKit.status}</div>
          </CardContent>
        </Card>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="prose prose-sm dark:prose-invert max-w-none">
              <p className="whitespace-pre-wrap line-clamp-6">{studyKit.summary}</p>
            </div>
