        ...
        <div className="relative container mx-auto px-4 py-24 lg:py-32">
          <div className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Transform your lecture slides and notes into powerful study materials. 
              Get AI-generated summaries, flashcards, practice exams, and a personal tutor available 24/7.
            </p>
      ...
      <section className="border-y bg-muted/30">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <StatCard icon={<Users className="h-5 w-5" />} value="10,000+" label="Active Students" />
            <StatCard icon={<BookOpen className="h-5 w-5" />} value="500K+" label="Study Kits Created" />
            <StatCard icon={<Clock className="h-5 w-5" />} value="2M+" label="Hours Saved" />
            <StatCard icon={<TrendingUp className="h-5 w-5" />} value="94%" label="Grade Improvement" />
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 mx-auto">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Stop wasting time organizing notes. Let our AI transform your materials into a complete study kit in seconds.
            </p>
          </div>
      ...
      <section className="py-24 bg-primary text-primary-foreground">
        <div className="container px-4 mx-auto text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <Button size="lg" variant="secondary" className="h-12 px-8 text-base gap-2 group" asChild>
              <Link href="/dashboard">
...
function PricingCard({
  ...
  return (
    <Card className={`relative flex flex-col transition-all duration-300 hover:shadow-xl ${
      popular 
