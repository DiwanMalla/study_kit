          ...
          <div className="relative container mx-auto px-4 py-24 lg:py-32">
            <div className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                Turn your notes into a complete{" "}
                <span className="text-primary">study kit</span>
              </h1>

              <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
                Transform your lecture slides and notes into powerful study
                materials. Get AI-generated summaries, flashcards, practice
                exams, and a personal tutor available 24/7.
              </p>
        ...
        <section id="pricing" className="py-24 bg-background">
          <div className="container px-4 mx-auto">
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                Start for free, upgrade when you need more power. Cancel
                anytime.
              </p>
            </div>
