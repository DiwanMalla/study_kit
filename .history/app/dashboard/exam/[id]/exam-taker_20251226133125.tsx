...
export function ExamTaker({ exam }: ExamTakerProps) {
  ...
  if (examComplete) {
    ...
    const skippedCount = exam.questions.length - answers.size;
    const grade =
      score >= 90
        ? "A"
        : score >= 80
    ...
    return (
      <main className="flex-1 h-full overflow-y-auto bg-background p-6 md:p-8 relative">
        <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-gradient-to-b from-primary/5 to-transparent rounded-bl-full pointer-events-none"></div>
        <div className="max-w-[1600px] mx-auto h-full flex flex-col relative z-10 pb-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              <div className="bg-primary rounded-[2rem] p-6 text-center relative overflow-hidden shadow-lg shadow-primary/20">
                ...
                <button className="w-full py-3 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-black transition-all flex items-center justify-center gap-2">
              ...
              <div className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-2xl p-6 shadow-sm">
                ...
                <div className="mt-4 pt-4 border-t border-slate-100 dark:border-white/5">
                  <p className="text-xs text-slate-500 leading-relaxed">
                    ...
                    Review the incorrect questions to improve your overall
                    score.
                  </p>
                </div>
              </div>
                  ...
                  {currentQuestion.type === "short_answer" ? (
                    <div className="space-y-4">
                      <textarea
                        ...
                        value={answers.get(currentIndex) !== undefined ? currentQuestion.options[answers.get(currentIndex)!] : ""}
                        onChange={(e) => {
                      ...
                      <p className="text-xs text-slate-500 italic">
                        Note: Short answer questions are self-graded. Your response will be compared with the ideal answer in the results.
                      </p>
                    </div>
                  ) : (
