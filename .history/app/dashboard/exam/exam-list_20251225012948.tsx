    ...
    <div className="max-w-6xl mx-auto flex flex-col h-full">
      ...
      {filteredExams.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <Link href="/dashboard/exam/new">
            <Button className="px-8 py-4 bg-primary text-white rounded-xl font-bold shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all flex items-center gap-2">
              <Plus className="w-5 h-5" />
