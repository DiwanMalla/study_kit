      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
        ...
        <div>
          <Link href="/dashboard/exam/new">
            <Button className="px-6 py-3 bg-primary text-slate-900 rounded-xl font-bold shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-1 active:translate-y-0 active:shadow-md transition-all flex items-center gap-2">
      ...
      {filteredExams.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 max-w-md mb-8">
            You haven't created any mock exams yet. Start by creating one to test your knowledge.
          </p>
          <Link href="/dashboard/exam/new">
            <Button className="px-8 py-4 bg-primary text-slate-900 rounded-xl font-bold shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all flex items-center gap-2">
              <Plus className="w-5 h-5" />
