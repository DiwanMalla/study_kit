        ...
        <div className="flex flex-wrap justify-between items-end gap-4">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-muted-foreground text-base">
              Generate full-length mock exams and comprehensive study guides
              from your materials.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 flex flex-col gap-8">
          ...
          <div className="bg-surface rounded-3xl border border-border p-8 shadow-sm flex flex-col md:flex-row items-center gap-8 border-l-[6px] border-l-primary/50">
            ...
            <div className="flex flex-col gap-2 text-center md:text-left">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Upload your materials to calculate your current readiness. We
                analyze your comprehension levels across all generated mock
                sessions.
              </p>
            ...
            <div className="bg-surface border border-border rounded-2xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-md transition-all">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Simulate real exam pressure with our countdown engine.
                </p>
              </div>
            </div>
            <div className="bg-surface border border-border rounded-2xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-md transition-all">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Step-by-step guides on how to improve your weak areas.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-border/50 p-12 text-center bg-muted/5">
            ...
            <h3 className="text-lg font-bold text-muted-foreground/50 italic">
              Waiting for Input
            </h3>
            <p className="text-xs text-muted-foreground/40 mt-1">
              Your exam preparation portal will activate once you provide study
              content.
            </p>
          </div>
        </div>
