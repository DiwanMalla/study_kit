              ...
              {assignment.status === "processing" ? (
                <div className="flex flex-col items-center justify-center py-20 space-y-4 text-center">
                  ...
                  <p className="text-muted-foreground max-w-sm">
                    We are reviewing the files and instructions to generate a
                    comprehensive solution. This may take a minute.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center justify-center py-20 space-y-4 text-center text-red-500">
                  ...
                  <p className="text-muted-foreground max-w-sm">
                    Something went wrong while processing your assignment.
                    Please try again.
                  </p>
                  <Button
                    variant="outline"
