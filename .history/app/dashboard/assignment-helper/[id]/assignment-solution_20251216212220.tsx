          ...
          {assignment.status === "processing" ? (
            ...
            <>
              <Card>
                ...
                <CardContent>
                  <div className="prose prose-sm md:prose-base dark:prose-invert max-w-none leading-relaxed [&_p]:my-3 [&_li]:my-1 [&_ul]:my-3 [&_ol]:my-3 [&_h1]:my-4 [&_h2]:my-4 [&_h3]:my-3 [&_pre]:my-4 [&_pre]:overflow-x-auto [&_blockquote]:my-4">
                    <ReactMarkdown
