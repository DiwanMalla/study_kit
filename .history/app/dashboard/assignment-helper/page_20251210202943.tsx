    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Break down tasks and get organized fast.</p>
        </div>
      ...
      <Card>
        <CardHeader className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Generate checklists and timelines. Coming soon.</p>
          </div>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col items-center justify-center rounded-lg border border-dashed bg-muted/30 p-8 text-center text-muted-foreground">
            ...
            <p className="text-sm">You will soon turn prompts into actionable steps with due dates.</p>
          </div>
        </CardContent>
      </Card>
    </div>
