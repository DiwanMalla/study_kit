      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-surface rounded-xl border border-border p-6 shadow-sm flex flex-col gap-6">
          <div className="flex justify-between items-start">
            ...
            <span className="bg-primary/20 text-[#0f172a] text-xs font-bold px-2 py-1 rounded-full">
              New
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-end">
            <div className="flex-1 w-full">
              ...
              <div className="relative">
                ...
                <span className="material-symbols-outlined absolute right-3 top-2.5 text-muted-foreground pointer-events-none text-sm">
                  expand_more
                </span>
              </div>
            </div>
