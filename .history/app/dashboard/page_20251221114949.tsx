  ...
  return (
    <div className="max-w-[1200px] mx-auto p-6 md:p-10 flex flex-col gap-8 pb-20">
          ...
          <div className="flex flex-col gap-3 overflow-y-auto max-h-[300px] pr-1">
            {studyKits.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-10 text-center opacity-50">
                <span className="material-symbols-outlined text-[40px] mb-2">folder</span>
      ...
      <section className="flex flex-col gap-6">
        <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">AI Study Tools</h3>
