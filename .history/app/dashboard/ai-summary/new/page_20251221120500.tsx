...
const MODELS = [
  { id: "auto", name: "Auto (Recommended)", description: "Best balance of speed and quality" },
  { id: "llama-3.1-8b-instant", name: "Fast — Llama 3.1 8B", description: "Ultra-fast responses" },
  { id: "llama-3.3-70b-versatile", name: "Balanced — Llama 3.3 70B", description: "Great for academic content" },
  { id: "meta-llama/llama-4-scout-17b-16e-instruct", name: "Reasoning — Llama 4 Scout", description: "Deep understanding" },
  { id: "meta-llama/llama-4-maverick-17b-128e-instruct", name: "Best — Llama 4 Maverick", description: "Highest quality outputs" },
  { id: "qwen/qwen3-32b", name: "Reasoning — Qwen3 32B", description: "Excellent at complex tasks" },
  { id: "or:mistralai/devstral-2-2512", name: "Devstral 2 (OpenRouter)", description: "Open source excellence" },
  { id: "or:kwaipilot/kat-coder-pro-v1", name: "KAT-Coder-Pro (OpenRouter)", description: "Strong coding & logic" },
  { id: "or:tngtech/deepseek-r1t2-chimera", name: "DeepSeek R1T2 (OpenRouter)", description: "Specialized reasoning" },
];
            ...
            <div className="flex gap-3">
              {(["short", "medium", "long"] as SummaryLength[]).map((l) => (
                ...
                >
                  ...
                  <span className={cn("text-[10px] font-normal", length === l ? "text-white/80" : "text-slate-400")}>
                    {l === "short" && "~150 words"}
                    {l === "medium" && "~300 words"}
                    {l === "long" && "~600 words"}
                  </span>
            ...
            <div className="space-y-6 flex-grow flex flex-col">
              <div className="flex-grow flex flex-col">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-xs text-slate-400 font-medium">Max 50k chars</span>
                </div>
                <Textarea
      ...
      <div className="fixed bottom-8 left-0 right-0 px-4 md:px-0 z-50 pointer-events-none">
        <div className="w-full max-w-[1600px] mx-auto px-6 md:px-10 flex justify-end pointer-events-auto">
          <Button
            ...
            disabled={loading || uploading || (!content.trim() && !uploadedFile)}
          >
            {loading ? (
              <>
