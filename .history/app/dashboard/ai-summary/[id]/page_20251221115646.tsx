...
export default async function SummaryDetailPage({
  ...
  return (
    <div className="max-w-screen-xl mx-auto flex flex-col h-full px-6 md:px-10 py-6 md:py-10">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-card border border-border rounded-2xl p-6 md:p-8 shadow-sm h-full">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <div className="text-sm leading-relaxed text-slate-600 dark:text-slate-300 whitespace-pre-wrap max-h-[600px] overflow-y-auto">
                {summary.sourceText}
              </div>
            </div>
          </div>
