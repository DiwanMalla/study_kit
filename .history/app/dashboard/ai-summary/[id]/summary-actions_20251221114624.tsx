    ...
    <div className="flex items-center gap-3">
      ...
      >
        {copied ? (
          ...
          <span className="material-symbols-outlined text-[20px] group-hover:text-primary transition-colors">content_copy</span>
        )}
      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="rounded-3xl border-none shadow-2xl p-8">
          ...
          <AlertDialogFooter className="gap-3">
            <AlertDialogCancel className="rounded-full px-6 border-border">Cancel</AlertDialogCancel>
            <AlertDialogAction
              onClick={(e) => {
                e.preventDefault();
                handleDelete();
