    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">One-to-one guidance for tough topics.</p>
        </div>
        <Button asChild>
          <Link href="/dashboard">
            Back to overview
      ...
      <Card>
        <CardHeader className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Live AI tutoring experience coming soon.</p>
          </div>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col items-center justify-center rounded-lg border border-dashed bg-muted/30 p-8 text-center text-muted-foreground">
            ...
            <p className="text-sm">We are building a guided chat with context from your study kits.</p>
          </div>
        </CardContent>
      </Card>
    </div>
