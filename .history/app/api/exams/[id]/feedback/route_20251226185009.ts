...
export async function POST(
  ...
  try {
    ...
    const missed = exam.questions
      .map((q, idx) => {
        ...
        const isCorrect = (() => {
          ...
          if (typeof userAnswer === "number") return userAnswer === q.correctAnswer;
    ...
    const model =
      process.env.OPENROUTER_EXAM_FEEDBACK_MODEL ||
...
Time spent (seconds): ${typeof body.timeSpentSeconds === "number" ? body.timeSpentSeconds : "N/A"}
