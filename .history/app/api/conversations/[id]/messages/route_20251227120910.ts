        ...
        try {
          if (provider === "gemini") {
            ...
            let cleanedPrompt = message
              ...
              .replace(/can you (generate|create|show me) an image of/i, "")
              .replace(/(generate|create|show me) an image of/i, "")
              .replace(/can you (generate|create|show me) an image/i, "")
              .replace(/(generate|create|show me) an image/i, "")
              .trim();
