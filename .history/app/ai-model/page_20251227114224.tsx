...
export default function Page() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-xl flex flex-col gap-4 mb-8">
        <textarea
      ...
      {imageUrl && (
        <div className="flex flex-col items-center">
          <img src={imageUrl} alt="Generated" className="rounded shadow max-w-full max-h-[500px]" />
          <a href={imageUrl} target="_blank" rel="noopener noreferrer" className="mt-2 text-blue-600 underline">Open image in new tab</a>
        </div>
      )}
    </main>
  );
